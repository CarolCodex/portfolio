...
export const activityHeroSlides: ActivityHeroSlide[] = [
  {
    ...
    cards: [
      { id: 1, name: '泰国进口 金枕榴莲肉', tag: '热卖商品', price: '298', image: `${imageBase}/product-durian-slice-900.jpg` },
      { id: 2, name: '新鲜红肉蜜柚 2只约2.5kg', tag: '热卖商品', price: '99', image: `${imageBase}/product-pomelo-900.jpg` },
      ...
      { id: 5, name: '有机水培生菜 300g/袋', tag: '热卖商品', price: '8.9', image: '/case-assets/liangxuan-mini-program/demo-category-assets/images/product-lettuce-900.jpg' },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: 10, name: '泰国金枕头榴莲 3-4kg', tag: '团购商品', price: '139', image: `${imageBase}/product-durian-900.jpg` },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: 21, name: '泰国金枕头榴莲 3-4kg', tag: '预售特惠', price: '139', image: `${imageBase}/product-durian-900.jpg` },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: 29, name: '泰国金枕头榴莲 2.5kg', tag: '秒杀商品', price: '139', image: `${imageBase}/product-durian-900.jpg` },
      { id: 30, name: '新鲜红肉蜜柚 2只约2.5kg', tag: '秒杀商品', price: '19.9', image: `${imageBase}/product-pomelo-900.jpg` },
...
export const activityProducts: Record<ActivityType, ActivityProduct[]> = {
  hot: [
    {
      ...
      tag: '近7天爆卖 2.5万件',
      price: '39.9',
      image: `${imageBase}/product-durian-slice-900.jpg`,
    },
    {
      id: 102,
      rank: 'TOP 2',
      ...
      tag: '月销 3000+',
      price: '19.9',
      image: `${imageBase}/product-pomelo-900.jpg`,
    },
    {
      id: 103,
      rank: 'TOP 3',
  ...
  group: [
    ...
    },
    {
      ...
      originalPrice: '199',
      price: '139',
      image: `${imageBase}/product-durian-900.jpg`,
      actionText: '加入购物车',
    },
  ],
  presale: [
